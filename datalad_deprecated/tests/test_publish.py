...
@with_tempfile(mkdir=True)
@with_tempfile(mkdir=True)
def test_publish_recursive(pristine_origin=None, origin_path, src_path=None, dst_path=None, sub1_pub=None, sub2_pub=None):
...
@with_tempfile(mkdir=True)
@with_tempfile
def test_publish_with_data(origin=None, src_path, dst_path=None, sub1_pub=None, sub2_pub=None, dst_clone_path=None):
